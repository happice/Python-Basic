...
# list1 = [1, 'cit', True]
# print(list[0])      # Get list1 index number 0 value.
# print(list[2])
# print(list[3])      # Get list1 index number 3 value. There is index number 3, so an error occurs

# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ #

# # You can use the index number to modify the value at that index number
# # Changing the value can be done as id saving the value in a variable
# a = [1, 'cit', True]
# print(a)
...
#     print(i)            # Get the elem1ents of a list ine by one
# print()
